...
CREATE TABLE `plan` (
  ...
  `ignore_active` int(1) NOT NULL,
  `ignore_top` int(10) DEFAULT '0' COMMENT 'px',
  `ignore_left` int(10) DEFAULT '0' COMMENT 'px',
  `ignore_width` int(10) DEFAULT '0' COMMENT 'px',
  `ignore_height` int(10) DEFAULT '0' COMMENT 'px',
  PRIMARY KEY (`id_plan`),
...
INSERT INTO `plan` (`id_plan`, `id_user`, `id_source`, `id_target`, `start_date`, `primary_email`, `secondary_email`, `status`, `start_type`, `start_value`, `end_type`, `end_occurrence`, `end_date`, `color`, `background`, `tolerance`, `difference`, `ignore_active`, `ignore_top`, `ignore_left`, `ignore_width`, `ignore_height`) VALUES
(34,	20,	38,	37,	'2017-02-28 19:20:00',	'admin@example.org',	'',	1,	1,	1,	1,	5,	'2017-04-27 10:26:00',	'red',	'grayscale',	50,	10,	0,	0,	0,	0,	0),
(35,	20,	38,	37,	'2017-03-10 10:15:00',	'admin@example.org',	'',	1,	1,	1,	1,	5,	'2017-04-27 10:26:00',	'yellow',	'black',	20,	0,	0,	NULL,	NULL,	NULL,	NULL),
(41,	20,	48,	49,	'2017-03-09 17:10:00',	'admin@example.org',	'',	1,	1,	1,	1,	5,	'2017-04-27 10:26:00',	'red',	'grayscale',	20,	2,	0,	NULL,	NULL,	NULL,	NULL),
(42,	20,	48,	49,	'2017-03-09 17:10:00',	'test@example.org',	'',	1,	1,	1,	1,	5,	'2017-04-27 10:26:00',	'red',	'grayscale',	20,	2,	0,	NULL,	NULL,	NULL,	NULL),
(45,	20,	56,	55,	'2017-03-10 21:49:00',	'admin@example.org',	'',	0,	1,	0,	1,	0,	NULL,	'red',	'grayscale',	0,	0,	0,	0,	0,	0,	0),
(46,	20,	55,	56,	'2017-03-10 22:23:00',	'admin@example.org',	'',	0,	1,	0,	1,	0,	NULL,	'green',	'grayscale',	10,	1,	0,	0,	0,	0,	0);

DROP TABLE IF EXISTS `plan_result`;
CREATE TABLE `plan_result` (
  `id_plan_result` int(10) NOT NULL AUTO_INCREMENT,
  `id_source` int(10) NOT NULL,
  `id_plan_target` int(10) NOT NULL,
  `id_plan` int(11) NOT NULL,
  `color` varchar(100) COLLATE utf8_czech_ci NOT NULL,
  `background` varchar(100) COLLATE utf8_czech_ci NOT NULL,
  `tolerance` int(10) NOT NULL COMMENT 'Tolerance in %',
  `difference` float NOT NULL COMMENT 'Differences in comparison in %',
  `difference_result` float NOT NULL COMMENT 'Differences result in %',
  ...
  PRIMARY KEY (`id_plan_result`),
  KEY `id_source` (`id_source`),
  KEY `id_plan_target` (`id_plan_target`),
  KEY `id_plan` (`id_plan`),
  CONSTRAINT `plan_result_ibfk_1` FOREIGN KEY (`id_source`) REFERENCES `shoot` (`id_shoot`) ON DELETE CASCADE,
  CONSTRAINT `plan_result_ibfk_2` FOREIGN KEY (`id_plan_target`) REFERENCES `plan_target` (`id_plan_target`) ON DELETE CASCADE,
  CONSTRAINT `plan_result_ibfk_3` FOREIGN KEY (`id_plan`) REFERENCES `plan` (`id_plan`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;

INSERT INTO `plan_result` (`id_plan_result`, `id_source`, `id_plan_target`, `id_plan`, `color`, `background`, `tolerance`, `difference`, `difference_result`, `ignore_active`, `ignore_top`, `ignore_left`, `ignore_width`, `ignore_height`, `path_img`, `date`) VALUES
(27,	56,	86,	45,	'red',	'grayscale',	0,	0,	58,	0,	0,	0,	0,	0,	'/WS/plans/results/1489179844-www.bymini.cz-chromebook-11-1366x768.jpg',	'2017-03-10 22:04:04'),
(28,	55,	87,	46,	'red',	'white',	10,	1,	1.57,	0,	0,	0,	0,	0,	'/WS/plans/results/1489181015-www.bymini.cz-chromebook-11-1366x768.png',	'2017-03-10 22:23:35'),
(29,	55,	88,	46,	'green',	'grayscale',	10,	1,	1.76,	0,	0,	0,	0,	0,	'/WS/plans/results/1489181093-www.bymini.cz-chromebook-11-1366x768.png',	'2017-03-10 22:24:53');

DROP TABLE IF EXISTS `plan_target`;
CREATE TABLE `plan_target` (
  `id_plan_target` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_plan_target`),
  KEY `id_user` (`id_user`),
  KEY `id_device` (`id_device`),
  KEY `id_plan_target` (`id_plan_target`),
  CONSTRAINT `plan_target_ibfk_1` FOREIGN KEY (`id_device`) REFERENCES `device` (`id_device`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `plan_target_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;

INSERT INTO `plan_target` (`id_plan_target`, `id_user`, `id_device`, `date`, `engine`, `browser_name`, `browser_version`, `url`, `url_autority`, `img_type`, `img_mime`, `path_img`, `path_js`, `other_width`, `other_height`, `crop_viewport_width`, `crop_viewport_height`, `crop_top`, `crop_left`, `crop_width`, `crop_height`) VALUES
(83,	20,	34,	'2017-03-10 21:49:39',	'webkit',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'png',	'image/png',	'/WS/plans/targets/1489178979-www.bymini.cz-chromebook-11-1366x768.png',	'/WS/js/1489178979-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(84,	20,	34,	'2017-03-10 21:50:14',	'webkit',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'png',	'image/png',	'/WS/plans/targets/1489179014-www.bymini.cz-chromebook-11-1366x768.png',	'/WS/js/1489179014-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(85,	20,	34,	'2017-03-10 22:03:33',	'webkit',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'png',	'image/png',	'/WS/plans/targets/1489179813-www.bymini.cz-chromebook-11-1366x768.png',	'/WS/js/1489179813-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(86,	20,	34,	'2017-03-10 22:03:51',	'webkit',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'png',	'image/png',	'/WS/plans/targets/1489179831-www.bymini.cz-chromebook-11-1366x768.png',	'/WS/js/1489179831-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(87,	20,	34,	'2017-03-10 22:23:21',	'gecko',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'jpg',	'image/jpg',	'/WS/plans/targets/1489181001-www.bymini.cz-chromebook-11-1366x768.jpg',	'/WS/js/1489181001-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(88,	20,	34,	'2017-03-10 22:24:39',	'gecko',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'jpg',	'image/jpg',	'/WS/plans/targets/1489181079-www.bymini.cz-chromebook-11-1366x768.jpg',	'/WS/js/1489181079-www.bymini.cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);
...
(37,	36,	'red',	'grayscale',	0,	0,	0,	NULL,	NULL,	NULL,	NULL,	'/WS/results/1487675453-www-apul-cz-dell-venue-8-800x1280.jpg',	'2017-03-10 10:38:22'),
(49,	48,	'red',	'grayscale',	0,	26.53,	0,	NULL,	NULL,	NULL,	NULL,	'/WS/results/1488105940-www-czc-cz-ipad-768x1024.jpg',	'2017-03-10 09:42:59'),
(53,	37,	'red',	'grayscale',	0,	0,	0,	NULL,	NULL,	NULL,	NULL,	'/WS/results/1489138736-www.apul.cz-dell-venue-8-800x1280.jpg',	'2017-03-10 11:42:29'),
(55,	56,	'red',	'white',	10,	1.57,	0,	NULL,	NULL,	NULL,	NULL,	'/WS/results/1489157673-www-bymini-cz-chromebook-11-1366x768.png',	'2017-03-10 22:22:51'),
(56,	55,	'red',	'grayscale',	0,	58,	0,	NULL,	NULL,	NULL,	NULL,	'/WS/results/1489157703-www-bymini-cz-chromebook-11-1366x768.jpg',	'2017-03-10 21:34:46');
...
(53,	20,	48,	'2017-03-10 10:38:56',	'webkit',	'Chrome',	'56.0',	'http://www.apul.cz/',	'www.apul.cz',	'jpg',	'image/jpg',	'/WS/shoots/1489138736-www.apul.cz-dell-venue-8-800x1280.jpg',	'/WS/js/1489138736-www.apul.cz-dell-venue-8-800x1280.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(54,	20,	34,	'2017-03-10 11:19:36',	'webkit',	'Chrome',	'56.0',	'http://www.wpj.cz/',	'www.wpj.cz',	'jpg',	'image/jpg',	'/WS/shoots/1489141176-www-wpj-cz-chromebook-11-1366x768.jpg',	'/WS/js/1489141176-www-wpj-cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(55,	20,	34,	'2017-03-10 15:54:33',	'webkit',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'png',	'image/png',	'/WS/shoots/1489157673-www-bymini-cz-chromebook-11-1366x768.png',	'/WS/js/1489157673-www-bymini-cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
(56,	20,	34,	'2017-03-10 15:55:03',	'gecko',	'Chrome',	'56.0',	'http://www.bymini.cz/',	'www.bymini.cz',	'jpg',	'image/jpg',	'/WS/shoots/1489157703-www-bymini-cz-chromebook-11-1366x768.jpg',	'/WS/js/1489157703-www-bymini-cz-chromebook-11-1366x768.js',	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL);
