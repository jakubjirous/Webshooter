<?php
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app\FrontModule\presenters/templates/Sign/up.latte

use Latte\Runtime as LR;

class Template517e913e38 extends Latte\Runtime\Template
{
	public $blocks = [
		'menu' => 'blockMenu',
		'header' => 'blockHeader',
...
<?php
		/* line 19 */ $_tmp = $this->global->uiControl->getComponent("signUpForm");
		if ($_tmp instanceof Nette\Application\UI\IRenderable) $_tmp->redrawControl(NULL, FALSE);
		$_tmp->render();
?>
