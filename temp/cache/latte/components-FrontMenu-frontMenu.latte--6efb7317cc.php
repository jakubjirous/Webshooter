<?php
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app\FrontModule\presenters\templates\components\FrontMenu/frontMenu.latte

use Latte\Runtime as LR;

class Template6efb7317cc extends Latte\Runtime\Template
{
...
<nav class="navbar navbar-light navbar-fixed-top bg-faded">
   <div class="container">
      ...
      <div class="collapse navbar-toggleable-md" id="navbarResponsive">
		...
		if ($this->global->uiPresenter->isLinkCurrent('Device:list')) {
			?> active<?php
		}
?>">
