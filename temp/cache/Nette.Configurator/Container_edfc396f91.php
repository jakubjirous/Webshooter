<?php
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/config/config.neon 
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/config/config.local.neon 

class Container_edfc396f91 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\FrontModule\Forms\SignInFormFactory' => [1 => ['27_App_FrontModule_Forms_SignInFormFactory']],
			'App\FrontModule\Forms\SignUpFormFactory' => [1 => ['28_App_FrontModule_Forms_SignUpFormFactory']],
			'App\FrontModule\Forms\UserAddFormFactory' => [1 => ['29_App_FrontModule_Forms_UserAddFormFactory']],
			'App\FrontModule\Forms\UserEditFormFactory' => [1 => ['30_App_FrontModule_Forms_UserEditFormFactory']],
			'App\FrontModule\Model\DeviceManager' => [1 => ['31_App_FrontModule_Model_DeviceManager']],
			'App\FrontModule\Model\DeviceTypeManager' => [1 => ['32_App_FrontModule_Model_DeviceTypeManager']],
			'App\FrontModule\Model\SessionManager' => [1 => ['33_App_FrontModule_Model_SessionManager']],
			'Nette\Security\IAuthenticator' => [1 => ['34_App_FrontModule_Model_UserManager']],
			'App\FrontModule\Model\UserManager' => [1 => ['34_App_FrontModule_Model_UserManager']],
			'App\FrontModule\Model\UserRoleManager' => [1 => ['35_App_FrontModule_Model_UserRoleManager']],
		...
		'services' => [
			...
			'27_App_FrontModule_Forms_SignInFormFactory' => 'App\FrontModule\Forms\SignInFormFactory',
			'28_App_FrontModule_Forms_SignUpFormFactory' => 'App\FrontModule\Forms\SignUpFormFactory',
			'29_App_FrontModule_Forms_UserAddFormFactory' => 'App\FrontModule\Forms\UserAddFormFactory',
			'30_App_FrontModule_Forms_UserEditFormFactory' => 'App\FrontModule\Forms\UserEditFormFactory',
			'31_App_FrontModule_Model_DeviceManager' => 'App\FrontModule\Model\DeviceManager',
			'32_App_FrontModule_Model_DeviceTypeManager' => 'App\FrontModule\Model\DeviceTypeManager',
			'33_App_FrontModule_Model_SessionManager' => 'App\FrontModule\Model\SessionManager',
			'34_App_FrontModule_Model_UserManager' => 'App\FrontModule\Model\UserManager',
			'35_App_FrontModule_Model_UserRoleManager' => 'App\FrontModule\Model\UserRoleManager',
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app',
			'wwwDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/../temp',
		]);
	}
	...
	public function createService__24_App_FrontModule_Forms_DeviceAddFormFactory()
	{
		$service = new App\FrontModule\Forms\DeviceAddFormFactory($this->getService('26_App_FrontModule_Forms_FormFactory'),
			$this->getService('31_App_FrontModule_Model_DeviceManager'), $this->getService('32_App_FrontModule_Model_DeviceTypeManager'));
		return $service;
	}
	...
	public function createService__25_App_FrontModule_Forms_DeviceEditFormFactory()
	{
		$service = new App\FrontModule\Forms\DeviceEditFormFactory($this->getService('26_App_FrontModule_Forms_FormFactory'),
			$this->getService('33_App_FrontModule_Model_SessionManager'), $this->getService('31_App_FrontModule_Model_DeviceManager'),
			$this->getService('32_App_FrontModule_Model_DeviceTypeManager'));
		return $service;
	}
	 ...
	 */
	public function createService__27_App_FrontModule_Forms_SignInFormFactory()
	{
	 ...
	 */
	public function createService__28_App_FrontModule_Forms_SignUpFormFactory()
	{
		$service = new App\FrontModule\Forms\SignUpFormFactory($this->getService('26_App_FrontModule_Forms_FormFactory'),
			$this->getService('34_App_FrontModule_Model_UserManager'));
		return $service;
	}
	 ...
	 */
	public function createService__29_App_FrontModule_Forms_UserAddFormFactory()
	{
		$service = new App\FrontModule\Forms\UserAddFormFactory($this->getService('26_App_FrontModule_Forms_FormFactory'),
			$this->getService('34_App_FrontModule_Model_UserManager'), $this->getService('35_App_FrontModule_Model_UserRoleManager'));
		return $service;
	}
	 ...
	 */
	public function createService__30_App_FrontModule_Forms_UserEditFormFactory()
	{
		$service = new App\FrontModule\Forms\UserEditFormFactory($this->getService('26_App_FrontModule_Forms_FormFactory'),
			$this->getService('33_App_FrontModule_Model_SessionManager'), $this->getService('34_App_FrontModule_Model_UserManager'),
			$this->getService('35_App_FrontModule_Model_UserRoleManager'));
		return $service;
	}
	 ...
	 */
	public function createService__31_App_FrontModule_Model_DeviceManager()
	{
	 ...
	 */
	public function createService__32_App_FrontModule_Model_DeviceTypeManager()
	{
	 ...
	 */
	public function createService__33_App_FrontModule_Model_SessionManager()
	{
	 ...
	 */
	public function createService__34_App_FrontModule_Model_UserManager()
	{
	 ...
	 */
	public function createService__35_App_FrontModule_Model_UserRoleManager()
	{
	...
	{
		$service = new App\FrontModule\Presenters\DevicePresenter($this->getService('33_App_FrontModule_Model_SessionManager'),
			$this->getService('31_App_FrontModule_Model_DeviceManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__8()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->signUpFactory = $this->getService('28_App_FrontModule_Forms_SignUpFormFactory');
		$service->signInFactory = $this->getService('27_App_FrontModule_Forms_SignInFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new App\FrontModule\Presenters\UserPresenter($this->getService('33_App_FrontModule_Model_SessionManager'),
			$this->getService('34_App_FrontModule_Model_UserManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->userEditFactory = $this->getService('30_App_FrontModule_Forms_UserEditFormFactory');
		$service->userAddFactory = $this->getService('29_App_FrontModule_Forms_UserAddFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/../temp/cache',
	...
	{
		return new Container_edfc396f91_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('34_App_FrontModule_Model_UserManager'));
...
final class Container_edfc396f91_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_edfc396f91 $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WS\app/../temp/cache/latte');
