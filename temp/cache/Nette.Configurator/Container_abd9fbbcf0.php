<?php
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/config/config.neon 
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/config/config.local.neon 

class Container_abd9fbbcf0 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\FrontModule\Forms\FormFactory' => [1 => ['24_App_FrontModule_Forms_FormFactory']],
			'App\FrontModule\Forms\SignInFormFactory' => [1 => ['25_App_FrontModule_Forms_SignInFormFactory']],
			'App\FrontModule\Forms\SignUpFormFactory' => [1 => ['26_App_FrontModule_Forms_SignUpFormFactory']],
			'App\FrontModule\Model\DeviceManager' => [1 => ['27_App_FrontModule_Model_DeviceManager']],
			'Nette\Security\IAuthenticator' => [1 => ['28_App_FrontModule_Model_UserManager']],
			'App\FrontModule\Model\UserManager' => [1 => ['28_App_FrontModule_Model_UserManager']],
			...
			'App\FrontModule\Presenters\BasePresenter' => [
				1 => ['application.4', 'application.5', 'application.7', 'application.8'],
			],
		...
		'services' => [
			'24_App_FrontModule_Forms_FormFactory' => 'App\FrontModule\Forms\FormFactory',
			'25_App_FrontModule_Forms_SignInFormFactory' => 'App\FrontModule\Forms\SignInFormFactory',
			'26_App_FrontModule_Forms_SignUpFormFactory' => 'App\FrontModule\Forms\SignUpFormFactory',
			'27_App_FrontModule_Model_DeviceManager' => 'App\FrontModule\Model\DeviceManager',
			'28_App_FrontModule_Model_UserManager' => 'App\FrontModule\Model\UserManager',
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app',
			'wwwDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/../temp',
		]);
	}
	 ...
	 */
	public function createService__24_App_FrontModule_Forms_FormFactory()
	{
	 ...
	 */
	public function createService__25_App_FrontModule_Forms_SignInFormFactory()
	{
		$service = new App\FrontModule\Forms\SignInFormFactory($this->getService('24_App_FrontModule_Forms_FormFactory'),
	 ...
	 */
	public function createService__26_App_FrontModule_Forms_SignUpFormFactory()
	{
		$service = new App\FrontModule\Forms\SignUpFormFactory($this->getService('24_App_FrontModule_Forms_FormFactory'),
			$this->getService('28_App_FrontModule_Model_UserManager'));
		return $service;
	}
	 ...
	 */
	public function createService__27_App_FrontModule_Model_DeviceManager()
	{
	 ...
	 */
	public function createService__28_App_FrontModule_Model_UserManager()
	{
	...
	{
		$service = new App\FrontModule\Presenters\DevicePresenter($this->getService('27_App_FrontModule_Model_DeviceManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	public function createServiceApplication__8()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->signUpFactory = $this->getService('26_App_FrontModule_Forms_SignUpFormFactory');
		$service->signInFactory = $this->getService('25_App_FrontModule_Forms_SignInFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/../temp/cache',
	...
	{
		return new Container_abd9fbbcf0_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('28_App_FrontModule_Model_UserManager'));
...
final class Container_abd9fbbcf0_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_abd9fbbcf0 $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\WSM\app/../temp/cache/latte');
