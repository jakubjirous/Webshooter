<?php
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/config/config.neon 
// source: C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/config/config.local.neon 

class Container_300d2ce33a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app',
			'wwwDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/../temp/cache',
	...
	{
		return new Container_300d2ce33a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_300d2ce33a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_300d2ce33a $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\WPJ3Station\Disk Google\James\LOCALHOST\DP\sandbox\app/../temp/cache/latte');
