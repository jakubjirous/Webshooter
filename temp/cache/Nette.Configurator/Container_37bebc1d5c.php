<?php
// source: C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/config/config.neon 
// source: C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/config/config.local.neon 

class Container_37bebc1d5c extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app',
			'wwwDir' => 'C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/../temp/cache',
	...
	{
		return new Container_37bebc1d5c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_37bebc1d5c_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_37bebc1d5c $container)
	{
	...
	public function create(): Latte\Engine
	{
		...
		$service->setTempDirectory('C:\Users\WPJ3Station\DiskGoogle\James\LOCALHOST\DP\WS\app/../temp/cache/latte');
